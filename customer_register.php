...
if(isset($_POST['register'])){
    ...
    $query = "insert into customers (customer_name, customer_email, customer_pass, customer_country, customer_city, customer_contact, customer_address, customer_image, customer_ip, customer_confirm_code)
                values ('$c_name', '$c_email', '$c_pass', '$c_country', '$c_city', '$c_contact', '$c_address', '$c_image', '$c_ip', '$customer_confirm_code')";

    $run_query = mysqli_query($con, $query);
    if($run_query){
        echo "<script>alert('Account has been created successfully, please confirm your email address')</script>";
